...
exports.log = function (options) {
  var label       = (options.label) ? ((typeof options.label === 'function') ? options.label() : options.label) : null,
      timestamp   = (options.timestamp) ? ((typeof options.timestamp === 'function') ? options.timestamp() : options.timestamp) : null,
